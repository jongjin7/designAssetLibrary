...
export default function SearchPage() {
  ...
  const { query, setQuery, results, recentSearches, addRecentSearch, inputRef, hasQuery } = useSearch();
  ...
  return (
    <section className="search-screen">
      <div className="search-screen__header">
        ...
        />
        <button className="search-screen__cancel" onClick={() => router.push('/library')}>
          취소
        </button>
      </div>
