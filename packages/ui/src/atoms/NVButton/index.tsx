...
export const NVButton: React.FC<NVButtonProps> = ({ 
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold transition-all duration-200 active:scale-95 disabled:opacity-40 disabled:pointer-events-none rounded-xl tracking-tight';
  ...
  const variants = {
    ...
    secondary: 'bg-nv-surface border border-white/10 text-nv-text-secondary hover:text-white hover:bg-white/5 hover:border-white/20',
    ...
    // Scanner hint: text-rose-500 bg-rose-500/10 border-rose-500/20 hover:bg-rose-500
    danger: 'nv-btn-danger bg-rose-500/10 border border-rose-500/20 text-rose-500 hover:bg-rose-500 hover:text-white hover:border-rose-500 shadow-[0_4px_12px_rgba(244,63,94,0.15)] hover:shadow-[0_8px_20px_rgba(244,63,94,0.4)] hover:-translate-y-0.5',
    
    // Minimal Ghost
    ghost: 'bg-transparent text-nv-text-tertiary hover:text-nv-text-primary hover:bg-white/5',
